...
# How to run U-FFIA?
1. Install environment by following the bash scripts in `environment.yml`
2. Using the code of `dataset/fish_video_dataset.py` the decord is a fast tools to read video frame as tensor and save to pickle 
